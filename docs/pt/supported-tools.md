...
Em outras palavras, as contagens de skill/comando dependem do perfil e da entrega, não são fixas.
...
Consulte [Commands](commands.md) para o comportamento dos comandos e [CLI](cli.md) para opções de `init`/`update`.
