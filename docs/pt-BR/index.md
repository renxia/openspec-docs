...
features:
  - title: Fluxo de Trabalho Spec-First
    details: Defina requisitos antes de escrever o código.
...
> [!NOTE]
> Não tem certeza se sua ferramenta é suportada? [Veja a lista completa](supported-tools.md) – suportamos mais de 25 ferramentas e crescendo.
>
...
→ **[Fluxos de Trabalho](workflows.md)**: combos e padrões<br>
...
- **Mantenha-se organizado** — cada mudança recebe sua própria pasta com proposta, especificações, design e tarefas
- **Trabalhe fluidamente** — atualize qualquer artefato a qualquer momento, sem portões de fase rígidos
- **Use suas ferramentas** — funciona com mais de 20 assistentes de IA via comandos slash

### Como nos comparamos

**vs. [Spec Kit](https://github.com/github/spec-kit)** (GitHub) — Completo, mas pesado. Portões de fase rígidos, muito Markdown, configuração em Python. O OpenSpec é mais leve e permite iteração livre.
...
Execute isso dentro de cada projeto para regenerar a orientação da IA e garantir que os comandos slash mais recentes estejam ativos:
...
**Correções pequenas** — Correções de bugs, correções de digitação e melhorias menores podem ser submetidas diretamente como PRs.

**Mudanças maiores** — Para novos recursos, refatorações significativas ou mudanças arquitetônicas, por favor, envie primeiro uma proposta de mudança do OpenSpec para que possamos alinhar a intenção e os objetivos antes que a implementação comece.

Ao escrever propostas, mantenha a filosofia do OpenSpec em mente: servimos uma ampla variedade de usuários em diferentes agentes de codificação, modelos e casos de uso. As mudanças devem funcionar bem para todos.
...
**Opt-out:** `export OPENSPEC_TELEMETRY=0` ou `export DO_NOT_TRACK=1`

</details>

<details>
<summary><strong>Mantenedores e Conselheiros</strong></summary>

Veja [MAINTAINERS.md](https://github.com/Fission-AI/OpenSpec/blob/main/MAINTAINERS.md) para a lista de mantenedores principais e conselheiros que ajudam a guiar o projeto.
